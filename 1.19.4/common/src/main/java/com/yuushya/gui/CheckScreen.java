...
public class CheckScreen extends Screen {
    ...
    public static MutableComponent componentEmpty(){
        return Component.literal("");//(MutableComponent) TextComponent.EMPTY;
    }
    ...
    public static class InfoPanel{
        ...
        public InfoPanel(CheckFileUtils.Info info, Font font, int x, int y){
            ...
            this.x = x;
            this.y = y;
            this.descriptionLine = componentEmpty().append(Component.translatable("gui.yuushya.checkScreen.name."+info.id()).withStyle(ChatFormatting.BOLD).withStyle(ChatFormatting.GOLD))
