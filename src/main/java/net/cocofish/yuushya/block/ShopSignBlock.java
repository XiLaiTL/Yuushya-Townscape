...
public class ShopSignBlock extends IntactBlock {
    public ShopSignBlock(Settings settings, String registname, float ambientocclusionlightlevel,int linecount) {
        super(settings.luminance((state) -> { return 11; }), registname,ambientocclusionlightlevel,linecount);
    }
