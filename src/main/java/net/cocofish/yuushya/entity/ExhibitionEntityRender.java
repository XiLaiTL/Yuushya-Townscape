...
public class ExhibitionEntityRender extends EntityRenderer<ExhibitionEntity> {
    public ExhibitionEntityRender(EntityRenderDispatcher entityRenderDispatcher) {
    ...
    public void render(ExhibitionEntity fallingBlockEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        ...
        MinecraftClient.getInstance().getItemRenderer().renderItem((ItemStack) blockState.getBlock().asItem().getDefaultStack(), ModelTransformation.Mode.GROUND, lightAbove, OverlayTexture.DEFAULT_UV, matrixStack, vertexConsumerProvider);
        matrixStack.push();
