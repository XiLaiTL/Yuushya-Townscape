...
import net.cocofish.yuushya.blockentity.ModelFrameBlock;
import net.cocofish.yuushya.blockentity.ModelFrameBlockEntity;
...
import static net.cocofish.yuushya.Yuushya.exhibitionEntity;
                ...
                case "singlecolor":
                    ColorProviderRegistry.BLOCK.register(new BlockColorProvider() {
                        ...
                        public int getColor(BlockState state, BlockRenderView world, BlockPos pos, int tintIndex) {
                            return YM.String16toInt(yuushyaBlock.colorstring);
                        }
                    }, normalblock);break;
                case "vanilla":
        ...
        yuushyaitemmap.forEach((name,yuushyaItem)->{
            ...
            switch (yuushyaItem.classtype)
            {
                case "AbstractYuushyaItem":
                    normalitem=new AbstractYuushyaItem(yuushyaItem.settings,yuushyaItem.name,yuushyaItem.lines);break;
                case "HatItem":
                    normalitem=new HatItem(yuushyaItem.settings,yuushyaItem.name,yuushyaItem.lines);break;
                case "StructureCreatorItem":
                    normalitem=new StructureCreatorItem(yuushyaItem.settings,yuushyaItem.name,yuushyaItem.lines,yuushyaItem.createNbt,yuushyaItem.cancelNbt);break;
                default:
                    normalitem=new AbstractYuushyaItem(yuushyaItem.settings,yuushyaItem.name,yuushyaItem.lines);
            }
...
*/
    ...
    public void other_registry()
    {
       ...
       itemsregister.put("pos_trans_item",Registry.register(Registry.ITEM, new Identifier("yuushya", "pos_trans_item"),new PosTransItem(new FabricItemSettings().group(Yuushya.yuushyaitem),"pos_trans_item",4)));
        itemsregister.put("form_trans_item",Registry.register(Registry.ITEM, new Identifier("yuushya", "form_trans_item"),new FormTransItem(new FabricItemSettings().group(Yuushya.yuushyaitem),"form_trans_item",4)));
        itemsregister.put("get_showblock_item",Registry.register(Registry.ITEM, new Identifier("yuushya", "get_showblock_item"),new GetShowBlockEntityItem(new FabricItemSettings().group(Yuushya.yuushyaitem),"get_showblock_item",4)));
        itemsregister.put("get_mixedblock_item",Registry.register(Registry.ITEM, new Identifier("yuushya", "get_mixedblock_item"),new GetMixedBlockEntityItem(new FabricItemSettings().group(Yuushya.yuushyaitem),"get_mixedblock_item",4)));
