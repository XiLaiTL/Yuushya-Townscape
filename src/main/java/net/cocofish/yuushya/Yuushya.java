...
import net.cocofish.yuushya.item.GetEntityItem;
...
//(entitytype, World)->{return new ChairEntity((EntityType<ChairEntity>) (Object)entitytype,World);}
    ...
    public static final ItemGroup yuushyaextrashapes = FabricItemGroupBuilder.build(new Identifier("yuushya", "yuushya_extrashapes"),() -> new ItemStack(yuushyaElements.blocksregister.get("020")));
    public static final ItemGroup yuushyafurniture = FabricItemGroupBuilder.build(new Identifier("yuushya", "yuushya_furniture"),() -> new ItemStack(yuushyaElements.blocksregister.get("130")));
    public static final ItemGroup yuushyadecoration = FabricItemGroupBuilder.build(new Identifier("yuushya", "yuushya_decoration"),() -> new ItemStack(yuushyaElements.blocksregister.get("550")));
    public static final ItemGroup yuushyasigns = FabricItemGroupBuilder.build(new Identifier("yuushya", "yuushya_signs"),() -> new ItemStack(yuushyaElements.blocksregister.get("362")));
    public static final ItemGroup yuushyalife = FabricItemGroupBuilder.build(new Identifier("yuushya", "yuushya_life"),() -> new ItemStack(yuushyaElements.blocksregister.get("412")));
    public static final ItemGroup yuushyaextrablocks = FabricItemGroupBuilder.build(new Identifier("yuushya", "yuushya_extrablocks"),() -> new ItemStack(yuushyaElements.blocksregister.get("24")));
    public static final ItemGroup yuushyainfrastructure = FabricItemGroupBuilder.build(new Identifier("yuushya", "yuushya_infrastructure"),() -> new ItemStack(yuushyaElements.blocksregister.get("523")));
    public static final ItemGroup yuushyaitem = FabricItemGroupBuilder.build(new Identifier("yuushya", "yuushya_item"),() -> new ItemStack(yuushyaElements.itemsregister.get("pos_trans_item")));
    public static final ItemGroup yuushyastructure = FabricItemGroupBuilder.build(new Identifier("yuushya", "yuushya_structure"),() -> new ItemStack(yuushyaElements.itemsregister.get("maple_tree")));

    public static final YuushyaMethod YM=new YuushyaMethod();
    ...
    public static final ShowBlock showblock = new ShowBlock(Block.Settings.of(Material.METAL).noCollision().nonOpaque().strength(4.0f),"showblock",1.0f,1);
    ...
    public static final MixedBlock mixedblock = new MixedBlock(Block.Settings.of(Material.METAL).nonOpaque().strength(4.0f),"mixedblock",1.0f,1);
    ...
    public void onInitialize() {
        ...
        modelframeblockentity = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier("yuushya","modelframeentity"), BlockEntityType.Builder.create(ModelFrameBlockEntity::new, modelframeblock).build(null));
        ...
        showblockentity = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier("yuushya","showblockentity"), BlockEntityType.Builder.create(ShowBlockEntity::new, showblock).build(null));
        ...
        mixedblockentity = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier("yuushya","mixedblockentity"), BlockEntityType.Builder.create(MixedBlockEntity::new, mixedblock).build(null));
...
//        Registry.register(Registry.ITEM, new Identifier("yuushya", "shelf"), new BlockItem(shelfblock, new Item.Settings().group(Yuushya.yuushyaitem)));
        ...
        shelfblockentity = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier("yuushya","shelf"), BlockEntityType.Builder.create(ShelfBlockEntity::new,yuushyaElements.shelfarray.toArray(abb)).build(null));
    ...
    {
        String version2=FabricLoader.getInstance().getModContainer("yuushya").get().getMetadata().getVersion().toString();
        return version2;
    }
