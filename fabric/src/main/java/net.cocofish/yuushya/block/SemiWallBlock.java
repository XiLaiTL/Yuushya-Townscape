...
public class SemiWallBlock extends IntactBlock {
    public SemiWallBlock(Settings settings, String registname, float ambientocclusionlightlevel,int linecount) {
        super(settings.nonOpaque(), registname,ambientocclusionlightlevel,linecount);
    }
