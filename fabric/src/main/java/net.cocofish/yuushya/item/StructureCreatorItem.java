...
public class StructureCreatorItem extends AbstractYuushyaItem {
    ...
    public StructureCreatorItem(Settings settings, int linecount, String createnbt, String cancelnbt) {
    ...
    public boolean loadStructure(ServerWorld serverWorld,Identifier structureName,BlockPos blockPos,ItemStack itemStack) {
        if (structureName != null) {
            ...
            return structure2 == null ? false : this.place(serverWorld, structure2.get(),blockPos1);
        } else {
            return false;
        }
    }
...
*/
    public boolean place(ServerWorld serverWorld, Structure structure,BlockPos blockPos) {
            ...
            structure.place(serverWorld,blockPos, blockPos, structurePlacementData, new Random(Util.getMeasuringTimeMs()),2);
            return true;
    ...
    public void readNbt(ItemStack itemStack){
        ...
        NbtList listTag = compoundTag.getList("Pos", 6);
        NbtList listTag1=compoundTag.getList("Size",6);
