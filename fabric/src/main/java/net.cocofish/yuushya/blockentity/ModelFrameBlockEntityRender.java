...
public class ModelFrameBlockEntityRender implements BlockEntityRenderer<ModelFrameBlockEntity> {
    // 唱片机物品栏位
    private static ItemStack stack = new ItemStack(Items.JUKEBOX, 1);

    public ModelFrameBlockEntityRender(BlockEntityRendererFactory.Context cnt) {}
...
//        }
        ...
        for(int k = 0; k < defaultedList.size(); ++k) {
            ...
            if (itemStack != ItemStack.EMPTY) {
                ...
                itemRenderer.renderItem(itemStack, ModelTransformation.Mode.FIXED, lightAbove, OverlayTexture.DEFAULT_UV, matrices, vertexConsumers,seed+0);
                matrices.pop();
            }
            else
            {
                ...
                matrices.translate(-0.3125D, -0.3125D, 0.0D);
                matrices.scale(0.375F, 0.375F, 0.375F);
                itemRenderer.renderItem(stack1, ModelTransformation.Mode.FIXED, lightAbove, OverlayTexture.DEFAULT_UV, matrices, vertexConsumers,seed+1);
                matrices.pop();
            }
        }
