package net.cocofish.yuushya.fabric.client;
...
public class ShowBlockModel extends net.cocofish.yuushya.blockentity.showblock.ShowBlockModel implements UnbakedModel,BakedModel, FabricBakedModel {
    @Override
