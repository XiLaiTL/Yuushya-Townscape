package com.yuushya.showblock.data.math;
...
public class Quaternion {
    ...
    public Vector3f toXYZ() {
        ...
        return Math.abs(k) > 0.999F * j ? new Vector3f(2.0F * (float) Math.atan2(this.i(), this.r()), l, 0.0F) : new Vector3f((float) Math.atan2(2.0F * this.j() * this.k() + 2.0F * this.i() * this.r(), f - g - h + i), l, (float) Math.atan2(2.0F * this.i() * this.j() + 2.0F * this.r() * this.k(), f + g - h - i));
    }
    ...
    public Vector3f toYXZ() {
        ...
        float k = 2.0F * this.r() * this.i() - 2.0F * this.j() * this.k();
        float l = (float) Math.asin(k / j);
        return Math.abs(k) > 0.999F * j ? new Vector3f(l, 2.0F * (float) Math.atan2(this.j(), this.r()), 0.0F) : new Vector3f(l, (float) Math.atan2(2.0F * this.i() * this.k() + 2.0F * this.j() * this.r(), f - g - h + i), (float) Math.atan2(2.0F * this.i() * this.j() + 2.0F * this.r() * this.k(), f - g + h - i));
    }
