...
public class RecipeData {
    ...
    public static ResourceLocation getBlueprint(String CreativeModeTab){
        return switch (CreativeModeTab) {
            case "yuushya_extrablocks" -> new ResourceLocation(Yuushya.MOD_ID,"block_blueprint");
            case "yuushya_furniture" -> new ResourceLocation(Yuushya.MOD_ID,"furniture_blueprint");
            case "yuushya_lighting" -> new ResourceLocation(Yuushya.MOD_ID,"furniture_blueprint");
            case "yuushya_decoration" -> new ResourceLocation(Yuushya.MOD_ID,"deco_blueprint");
            case "yuushya_signs" -> new ResourceLocation(Yuushya.MOD_ID,"sign_blueprint");
            case "yuushya_life" -> new ResourceLocation(Yuushya.MOD_ID,"dailylife_stuff_blueprint");
            case "yuushya_extrashapes" -> new ResourceLocation(Yuushya.MOD_ID,"extra_shapes_blueprint");
            case "yuushya_infrastructure" -> new ResourceLocation(Yuushya.MOD_ID,"facility_blueprint");
            //case "yuushya_structure" -> new ResourceLocation(Yuushya.MOD_ID,"extra_shapes_blueprint");
            default -> new ResourceLocation(Yuushya.MOD_ID,"extra_shapes_blueprint");
        };
    }
