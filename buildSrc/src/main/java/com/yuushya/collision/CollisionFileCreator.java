                        ...
                        if(obj.has("variants")) {//先不做multipart了
                            for(var pair:obj.getAsJsonObject("variants").entrySet()){
                                ...
                                if(model!=null){
                                    ...
                                    else if(ConfigReader.StaticBlockALL.containsKey(namespaceId.getPath())){
                                        String collisionType = ConfigReader.StaticBlockALL.get(namespaceId.getPath()).autoGenerated.collision;
                                        if (collisionType==null) collisionType = "bound";
