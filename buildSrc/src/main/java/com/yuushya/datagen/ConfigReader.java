...
public class ConfigReader {
    ...
    public void generateRegistries(){
                ...
                default -> {
                    ...
                    if(block.autoGenerated!=null) {
                        ...
                        if(block.autoGenerated.tags!=null&&!block.autoGenerated.tags.isEmpty()){
                            dataProvider.type(YuushyaDataProvider.DataType.Tags).add(block);}
                    }
                }
            }
        }
        ...
        for (YuushyaRegistryData.Block templateBlock:BlockTemplate.values()){
            ...
            if (templateBlock.autoGenerated!=null) {
                if(templateBlock.autoGenerated.itemModel)
                    YuushyaDataProvider.of(templateBlock.name).type(YuushyaDataProvider.DataType.ItemModel).add(templateBlock).save();
                if(templateBlock.autoGenerated.recipe)
                    YuushyaDataProvider.of(templateBlock.name).addTemplateBlockRecipe(templateBlock).save();
            }
        ...
        for(YuushyaRegistryData.Particle particle: YuushyaRawParticleMap.values()){
            ...
            dataProvider.type(YuushyaDataProvider.DataType.BlockState).json(()->BlockStateData.genSimpleBlock(ResourceLocation.parse("yuushya:extra_building_material/blank"))).save();
