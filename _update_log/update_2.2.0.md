...
![videoframe_192430.jpg](https://s2.loli.net/2024/09/17/9LEs8fgBVSRnqKQ.jpg)
...
再次点击已选中的图层，则标记当前图层（图层的背景变成红色）。当有图层被标记时，点击【+】的操作则为将标记的图层复制粘贴一份
...
在GUI界面中，新增了方块建模作品的保存功能，其可将分享码保存为JSON格式文件于本地（储存在 /版本文件夹/modellings/ 下）。这一功能能够实现跨存档保存建模作品，以及分享码的批量传播。对此，我们添加了一个【建模凿子】工具用于加载本地储存的分享码

对此我们还推出了[创意工坊](https://yuushya.com/townscape/workshop.html)页面，您可以在这个页面中获取到我们与玩家制作的作品的分享码。同时我们也欢迎您将自己的作品投稿至这里！
...
![2024-09-17_13.14.47.jpg](https://s2.loli.net/2024/09/17/4fBbkqN6u1cltiU.jpg)                  
...
![2024-09-17_13.21.13.jpg](https://s2.loli.net/2024/09/17/hlDXBCnEqiGZMzA.jpg)
...
![2024-09-17_13.25.30.jpg](https://s2.loli.net/2024/09/17/Pvdp2WsOCAZR6i4.jpg)
...
本次更新新增了多个一键生成建筑，其中大部分为各种形状和颜色的树，其余为生成建筑。特别感谢：seone、莓！
