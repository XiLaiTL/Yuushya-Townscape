...
public class ChairEntity extends Entity {
    ...
    @Override
    protected @NotNull Vec3 getPassengerAttachmentPoint(Entity entity, EntityDimensions dimensions, float scale) {
        float legacy = getEyeHeight()- 0.25f;
        boolean bl = entity instanceof Villager || entity instanceof WanderingTrader;
        return new Vec3(0.0f, bl ? legacy : legacy+ 0.1875f, 0.0f);
    }
