...
public class CheckScreen extends Screen {
    ...
    protected void init() {
        ...
        //Resource Pack
        for (Info info : checkResourcePacks()) {
    ...
    public static class InfoPanel{
        ...
        public InfoPanel(Info info, Font font, int x, int y){
            this.info = info;
            this.font = font;
            this.x = x;
            this.y = y;
        ...
        public void init(CheckScreen screen){
            ...
            links.forEach(screen::addButton);
        }
        /*
        Recommend Resource:
